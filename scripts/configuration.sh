...
sudo mkdir p8-deployments-3.3.0
mv p8-deployments-carbonplace-3.3.0 p8-deployments-3.3.0 ##need to change
ln -s /home/ubuntu/p8/p8-deployments-carbonplace-3.3.0 p8-deployments-3.3.0
